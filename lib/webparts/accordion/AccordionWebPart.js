...
var AccordionWebPart = /** @class */ (function (_super) {
    ...
    AccordionWebPart.prototype._getListItems = function () {
        return this.context.spHttpClient.get(this.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('AccordionList')/items?$select=Id,Title", SPHttpClient.configurations.v1)
            .then(function (response) {
    ...
    AccordionWebPart.prototype._updateListItem = function () {
        var _this = this;
        // get the first item
        return this.context.spHttpClient.get(this.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('AccordionList')/items?$select=Id,Title&$filter=Title eq 'United States'", SPHttpClient.configurations.v1)
            .then(function (response) {
            return response.json();
        })
            .then(function (jsonResponse) {
    ...
    AccordionWebPart.prototype._deleteListItem = function () {
        var _this = this;
        // get the last item
        return this.context.spHttpClient.get(this.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('AccordionList')/items?$select=Id,Title&$orderby=ID desc&$top=1", SPHttpClient.configurations.v1)
            .then(function (response) {
            return response.json();
        })
            .then(function (jsonResponse) {
